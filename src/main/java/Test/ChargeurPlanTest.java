...
public class ChargeurPlanTest {
    ...
    public void TUp2() {
        ...
        Noeud dernierNoeud = new Noeud(868438829L, 22507, 37639);
        boolean dernierNoeudPresent = false;
        Noeud noeudAleatoire = new Noeud(388568803L, 19085, 35264);
        boolean noeudAleatoirePresent = false;

        for (Noeud noeud : petitPlan.getListeNoeuds()) {
            if (noeud.getId() == (long) dernierNoeud.getId() && noeud.getX() == dernierNoeud.getX() && noeud.getY() == dernierNoeud.getY())
                dernierNoeudPresent = true;
            if (noeud.getId() == (long) noeudAleatoire.getId() && noeud.getX() == noeudAleatoire.getX() && noeud.getY() == noeudAleatoire.getY())
                noeudAleatoirePresent = true;
        }
    ...
    public void TUp3() {
        ...
        for (Troncon troncon : petitPlan.getListeTroncons()) {
            if (dernierTroncon.getLongueur() == troncon.getLongueur() && dernierTroncon.getNomRue().equals(troncon.getNomRue()))
                dernierTronconPresent = true;
        }
    ...
    public void TUm2() {
        ...
        Noeud dernierNoeud = new Noeud(984553654L, 43921, 66297);
        boolean dernierNoeudPresent = false;
        Noeud noeudAleatoire = new Noeud(26464258L, 56801, 97778);
        boolean noeudAleatoirePresent = false;
    ...
    public void TUg2() {
        ...
        Noeud dernierNoeud = new Noeud(998859048L, 204520, 193795);
        boolean dernierNoeudPresent = false;
        Noeud noeudAleatoire = new Noeud(429428854L, 143237, 233136);
        boolean noeudAleatoirePresent = false;
