...
public class PlanTest {
	...
	public void TU1() {
		...
		Noeud noeud = new Noeud(868438829L, 22507, 37639); boolean noeudPresent = false;
		plan.addNoeud(noeud);
		
		for (Noeud n : plan.getListeNoeuds()) {
            if(n.getId() == (long) noeud.getId() && n.getX() == noeud.getX() && n.getY() == noeud.getY()) noeudPresent = true;
        }
